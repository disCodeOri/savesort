...
const FAQS: FAQItem[] = [
  {
    question:
      "How does semantic search find links when I only remember a vague description?",
    answer:
  ...
  {
    question:
      "If I unstar a repository on GitHub, will Grapplin delete my saved bookmark?",
    answer:
  ...
  {
    question:
      "Can I save restricted social media platforms like X/Twitter or Instagram?",
    answer:
    ...
    >
      <div className="section-header">
        ...
        <p className="section-subtitle">
          Transparent answers about architecture, security, AI embeddings, and
          data retention.
        </p>
      </div>
